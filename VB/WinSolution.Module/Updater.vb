...
Namespace WinSolution.Module
    Public Class Updater
        ...
        Public Overrides Sub UpdateDatabaseAfterUpdateSchema()
            ...
            If ObjectSpace.FindObject(Of Person)(CriteriaOperator.Parse("FullName == 'Mary Tellitson'")) Is Nothing Then
                ...
                person1.Save()
            End If
            If ObjectSpace.FindObject(Of Person)(CriteriaOperator.Parse("FullName == 'Robert King'")) Is Nothing Then
