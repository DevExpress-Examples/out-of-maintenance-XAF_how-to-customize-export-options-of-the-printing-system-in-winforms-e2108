...
namespace WinSolution.Module {
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            if (ObjectSpace.FindObject<Person>(CriteriaOperator.Parse("FullName == 'Mary Tellitson'")) == null) {
            ...
            if (ObjectSpace.FindObject<Person>(CriteriaOperator.Parse("FullName == 'Robert King'")) == null)
            {
